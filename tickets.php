...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse subMenu">
  <div class="navbar-inner container-fluid container-fluid">
	...
	<li id="subMenuWaitingOnCS" ><a href="./tickets.php?ticketId=woc">Waiting on CS</a></li>
	<li id="subMenuProses" ><a href="./tickets.php?ticketId=woa">Proses</a></li>
...
?>
	...
	<div id="displayTickets" class="panel panel-default">
        	...
        	<?php }	elseif ($ticketId == 'woa') { ?>
							...
							<?php ticket::displayTickets('Suspect'); ?>
				...
				<form class="form" method="POST" enctype="multipart/form-data">
					...
					<input type="text" name="previousAssignedUser" value="<?php echo '' . $ticket->getAssignedUser();?>" hidden />
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-sm-10">
			                    	<textarea class="form-control verticalonly" name="Description" type="text" ><?php echo ''. $ticket->getComments(); ?> </textarea>
			                    </div>
			                </div>
